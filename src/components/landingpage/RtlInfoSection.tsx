...
// assets
const LightRTLImage = '/assets/images/landing/bg-rtl-info-light.svg';
const DarkRTLImage = '/assets/images/landing/bg-rtl-info-dark.svg';
const BgDark = '/assets/images/landing/bg-rtl-info-block-dark.png';
const BgLight = '/assets/images/landing/bg-rtl-info-block-light.png';
